...
print(f"Total gain_loss {sum_list:.2f}")
...
for key, value in portfolio_gain_loss_dict.items():
    sum_dict += value
...
def calc_total(input_list):
    start_val = 0.00
    for item in input_list:
        start_val += item
    return start_val

total_big_gains = calc_total(big_gains)
total_big_losses = calc_total(big_losses)
